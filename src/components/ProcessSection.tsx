...
import { Settings, Flame, Rocket, ArrowRight } from "lucide-react"
...
const steps = [
  {
    ...
    description:
      "Регистрируем домены, настраиваем почтовые ящики, прописываем SPF, DKIM и DMARC. Параллельно разрабатываем стратегию рассылки и пишем цепочку писем под вашу нишу.",
    number: "01",
  },
  {
    icon: Flame,
    title: "Прогрев и тестирование",
    description:
      "Прогреваем ящики 2–3 недели для обеспечения высокой доставляемости. Тестируем тексты, тему и офферы на небольших выборках перед полным запуском.",
    number: "02",
  },
  {
    icon: Rocket,
    ...
    description:
      "Запускаем кампанию на полную мощность, обрабатываем ответы и передаём вам тёплые лиды. Еженедельно предоставляем отчёт с метриками и рекомендациями.",
    number: "03",
  },
]
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            От <span className="text-primary">старта</span> до <span className="text-primary">первых лидов</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Три чётких этапа — и ваши потенциальные клиенты уже читают ваши письма.
          </p>
        </div>
